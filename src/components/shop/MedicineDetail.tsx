...
import { ArrowLeft, Pill, Plus, Minus, ShoppingCart, AlertCircle } from 'lucide-react';
...
const MedicineDetail: React.FC<MedicineDetailProps> = ({ medicine, onClose, onAddToCart }) => {
    ...
    <div className="h-full">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex justify-between items-start mb-4">
          ...
          <span className="text-teal-600 text-xl font-bold">${medicine.price.toFixed(2)}</span>
        </div>
          ...
          <div className="mt-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="text-right">
                ...
                <p className="text-xl font-bold text-teal-600">${(medicine.price * quantity).toFixed(2)}</p>
              </div>
            </div>

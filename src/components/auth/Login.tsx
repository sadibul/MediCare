    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 flex items-center justify-center p-4">
      ...
      >
        {showDoctorRegistration ? (
          <DoctorRegistration onBack={() => setShowDoctorRegistration(false)} />
        ) : (
          <>
            <motion.div
            ...
            <div className="flex border-b border-gray-200 mb-8">
              {['patient', 'doctor', 'admin'].map((type) => (
                <motion.button
                  ...
                  onClick={() =>
                    updateDefaultCredentials(type as typeof userType)
                  }
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600">
                {userType === 'doctor' ? (
                  ...
                  <>
                    Need assistance?{' '}
                    <motion.button className="text-primary-600 hover:text-primary-700 font-medium inline-flex items-center">
                      Contact Support
                      <ChevronRight size={16} className="ml-1" />
                    </motion.button>
                  </>

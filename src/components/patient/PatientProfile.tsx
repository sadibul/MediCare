...
import { User, Mail, Phone, MapPin, Calendar, Edit2, Save, X, Heart } from 'lucide-react';
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-600">{profile.bloodType}</span>
                    </div>
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-600">{profile.emergencyContact.relation}</p>
                  )}
                </div>
                <div>
